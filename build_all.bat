...
msbuild ChessEngineUCI.vcxproj /p:Configuration=Release /p:Platform=x64 /t:Rebuild /m /nologo
if exist x64\Release\UCI\ChessEngineUCI.exe move /y x64\Release\UCI\ChessEngineUCI.exe bin\ChessEngineUCI_x64.exe

msbuild ChessEngineUCI.vcxproj /p:Configuration=Release_MinSize /p:Platform=x64 /t:Rebuild /m /nologo
if exist x64\Release_MinSize\UCI\ChessEngineUCI.exe move /y x64\Release_MinSize\UCI\ChessEngineUCI.exe bin\ChessEngineUCI_x64_minSize.exe

msbuild ChessEngineUCI.vcxproj /p:Configuration=Release /p:Platform=Win32 /t:Rebuild /m /nologo
if exist Win32\Release\UCI\ChessEngineUCI.exe move /y Win32\Release\UCI\ChessEngineUCI.exe bin\ChessEngineUCI_x86.exe

msbuild ChessEngineUCI.vcxproj /p:Configuration=Release_MinSize /p:Platform=Win32 /t:Rebuild /m /nologo
if exist Win32\Release_MinSize\UCI\ChessEngineUCI.exe move /y Win32\Release_MinSize\UCI\ChessEngineUCI.exe bin\ChessEngineUCI_x86_minSize.exe
